# Generated by Django 4.0.6 on 2022-09-17 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Month', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tally2_app.months')),
                ('Voucher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tally2_app.statistics_vouchers')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Total', models.IntegerField(blank=True, default=0, null=True)),
                ('Accounts', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tally2_app.statistics_accounts')),
            ],
        ),
    ]
